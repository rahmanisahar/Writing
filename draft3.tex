...
\label{app:halpha}
\begin{figure*}
\includegraphics[width=164mm]{halpha_copy.eps}
\caption{Mosaic created using Montage programme from 6 fields of \halpha emission maps of m31 from \citpe{Massey07}. Result from Montage was continuum subtracted and masked out all point sources. Centre of galaxy was masked out due to saturation of data in R-band image.}
\label{fig:halpha}
\end{figure*}
