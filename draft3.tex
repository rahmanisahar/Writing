...
\begin{figure*}
\includegraphics[width=164mm]{c3d_all_ks_regs.png}
...
\begin{figure}
	\begin{subfigure}\\(a){}
  	\left
	\includegraphics[width=80mm]{es_tot_fuv_vs_h2.png}
 	\end{subfigure}%

	 \begin{subfigure}\\(b){}
	\right
	\includegraphics[width=80mm]{es_tot_fir_vs_h2.png}
 	\end{subfigure}
	
	 \begin{subfigure}\\(c){}
 	\left
	\includegraphics[width=80mm]{es_tot_fir_vs_hi.png}
 	\end{subfigure}

 	\begin{subfigure}\\(d){}
   	\right
	\includegraphics[width=80mm]{es_tot_fuv_vs_hi.png}
 	\end{subfigure}

 	\begin{subfigure}\\(e){}
   	\left
	\includegraphics[width=80mm]{es_tot_fir_vs_tot.png}
 	\end{subfigure}

 	\begin{subfigure}\\(f){}
   	\right
	\includegraphics[width=80mm]{es_tot_fuv_vs_tot.png}
	 \end{subfigure}
...
%PB: explain a little more here what you mean by "plots have different pixel size", or refer to the relevant text section.
   \label{fig:es,all}
 \end{figure}
